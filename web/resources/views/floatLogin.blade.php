<div class="floating_container flex_col center justify_between" style="
    ...
    >
    {{-- Đăng nhập --}}
        <form action="#" class="login flex_col align_center justify_around visible" style="width:100%; height:70%" method="POST">
            @csrf
            <h1>Đăng Nhập</h1>
    ...
    {{-- Đăng ký --}}
        <form action="#" class="register flex_col align_center justify_around invisible" style="width:100%; height:70%" method="POST">
            @csrf
            <h1>Đăng Ký</h1>
            <div class="flex_col label">
